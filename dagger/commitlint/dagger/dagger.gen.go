...
func (r Commitlint) MarshalJSON() ([]byte, error) {
	var concrete struct {
		Ctr *Container
	}
	concrete.Ctr = r.Ctr
...
func (r *Commitlint) UnmarshalJSON(bs []byte) error {
	var concrete struct {
		Ctr *Container
	}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "":
		return dag.Module().
			WithDescription("This module runs commitlint to validate conventional commits.\n").
			WithObject(
				dag.TypeDef().WithObject("Commitlint").
					...
					WithConstructor(
						dag.Function("New",
							dag.TypeDef().WithObject("Commitlint")).
							WithArg("Image", dag.TypeDef().WithKind(StringKind).WithOptional(true), FunctionWithArgOpts{Description: "Commitlint image to use.", DefaultValue: JSON("\"commitlint/commitlint\"")}))), nil
	default:
